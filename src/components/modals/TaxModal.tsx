      ...
      <div>
        ...
        <div className="mb-[3rem] text-[1.4rem] leading-[130%]">
          ...
          <p className="text-[1.2rem] leading-[130%] text-[var(--text-main)]">
            Сеть Tron взимает комиссию за перевод USDT (14 TRX ≈ 2.5$). Вам не нужно пополнять
            баланс TRX — мы сами оплачиваем эту комиссию, делая использование кошелька простым и
            удобным.
          </p>
        </div>
        <div className="mb-[2.4rem] text-[1.4rem] leading-[130%]">
          ...
          <p className="text-[1.2rem] leading-[130%] text-[var(--text-main)]">
            Эти средства покрывают себестоимость AML-проверки, которая гарантирует безопасность.
          </p>
        </div>
        <p className="text-[1.2rem] leading-[130%] text-[var(--text-secondary)]">
          Lynx Wallet получает 0% прибыли за этот перевод (в последующих релизах запланировано
          снижение комиссии для наших пользователей за счёт оптимизации работы с Tron).
        </p>
      </div>
    </Modal>
  );
