                ...
                <div id="application" className="mt-[3.2rem]">
                    ...
                    <div className="flex flex-col ">
                        <FaqItem
                            ...
                            answer="Когда появится приложение нашего кошелька? Lynx уже доступен прямо в Telegram — не нужно ничего скачивать или устанавливать. Просто откройте мини-приложение и пользуйтесь кошельком в привычном мессенджере."
                        />
                    </div>
                </div>
